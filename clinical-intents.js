...
export const clinicalIntentRegistry = [
  ...
  intent({
    ...
    label: "Thyroid storm, thyrotoxicosis, or myxedema concern",
    aliases: ["thyroid storm", "thyrotoxicosis", "hyperthyroid", "graves", "myxedema", "hypothyroid", "goiter", "heat intolerance", "cold intolerance", "palpitations with thyroid"],
    intent_type: "diagnosis",
