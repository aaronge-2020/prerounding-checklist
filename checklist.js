...
If a <retrieved_evidence_candidates> block is present without a validated intent block, treat it as a prioritized evidence-seeded starting point and completeness check, not as an exclusive list. Prefer relevant candidate bedside question labels/options and targeted exam labels/options when they fit the patient, but improve unclear wording and change options when clinically better. Do not copy low-relevance candidates merely because they were retrieved. Do not include citations or rationale text in the final checklist.
