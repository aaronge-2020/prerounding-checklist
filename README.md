...
- **Hospital Stay**: maintain the admission packet and labeled day-by-day updates in one place. A combined Epic paste is split into editable Results, Medication activity, and Vitals sources before one-click local de-identification and encrypted save; CPRS exports are also organized, omitted fields are not invented, and unrecognized text is retained for review.
