...
export const organSystemSchema = {
  ...
  functional_safety: {
    ...
    shortLabel: "Function",
    patterns: [
      /\b(?:main symptom|new symptom|main concern|important change|concern|discharge|home|follow-up|safety|safe|safely|function|baseline|bedbound|get out of bed|get up|walk|stand|activity|needs help|not tried|medicine access|medicines?|medications?|missed dose|missed doses|treatment|team to know|food|drinking|eating|oral intake|intake|urine output|access|question for team|sick day|arranged|general appearance|airway protection|mental status|pain score)\b/i
    ]
  }
};
