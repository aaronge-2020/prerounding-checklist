...
export function evaluateComplaintCds(inputText = "", answers = {}, options = {}) {
  ...
  const requiredExam = includedRequiredExam;
  const conditionalExam = includedConditionalExam;
  const allIncluded = [
    ...requiredQuestions,
    ...conditionalQuestions,
    ...requiredExam,
...
export function validateComplaintModules(modules = complaintModules, sources = complaintSourceRegistry) {
  ...
  const itemGroups = ["requiredQuestions", "conditionalQuestions", "requiredExam", "conditionalExam"];
