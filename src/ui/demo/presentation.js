export const DEMO_GUIDE_STAGES = Object.freeze({
  "save-context": { view: "daily", targetSelector: '[data-action="save-context"]', title: "Save the synthetic admission packet", instruction: "Use the real Hospital Stay save action. The app will create a local redaction draft from the fictional name and MRN." },
  "context-review": { view: "daily", targetSelector: '[data-action="keep-reviewed-redaction"]', title: "Review the redaction draft", instruction: "Accept each proposed redaction with the real review control. The demo advances only after every pending change is reviewed." },
  "save-day": { view: "daily", targetSelector: '[data-action="save-day"]', title: "Save the hospital-day update", instruction: "Save the synthetic overnight update with the real Hospital Stay control." },
  "daily-review": { view: "daily", targetSelector: '[data-action="keep-reviewed-redaction"]', title: "Review the hospital-day redaction draft", instruction: "Accept each date or identifier replacement with the real review control before continuing." },
