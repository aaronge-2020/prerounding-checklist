...
import { savePromptTemplateOverrides } from "../../prompts/custom-templates.js?v=20260921-medication-review-v3";
import { OPEN_EVIDENCE_TASKS } from "../../prompts/open-evidence.js?v=20260921-medication-review-v3";
...
export function createPromptTaskController({ state, setStatus, renderPrompts, refreshPromptPreview, byId }) {
  ...
  function updatePresentationToEdit(value) {
    ...
    state.presentationToEditEdited = true;
