...
import { createDemoPatient, DEMO_DAILY_TEXTS } from "./demo/session.js?v=20260726-demo-teaching-4";
import { createDemoSessionController } from "./demo/session-controller.js?v=20260726-demo-teaching-4";
