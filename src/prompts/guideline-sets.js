...
export const DEFAULT_GUIDELINE_SET_SOURCES = Object.freeze([
  ...
  { label: "Pre-round checklist", token: "@pre-round-checklist-guidelines", path: "./prompts/Pre-round_checklist.md", task: { id: "preround_bedside_exam", label: "Pre-round bedside exam", order: 10 } },
  { label: "Discharge instructions", token: "@discharge-instructions-guidelines", path: "./prompts/Discharge_Instructions.md", task: { id: "discharge_instructions", label: "Discharge instructions", order: 11 } },
  { label: "Consulting", token: "@consulting-guidelines", path: "./prompts/Consulting.md", task: { id: "consulting", label: "Consulting", order: 12 } },
  ...
  { label: "Teaching", token: "@teaching-guidelines", path: "./prompts/teaching.md", task: { id: "teaching_case_trajectory", label: "Teaching: full case trajectory", order: 6 } },
  ...
  { label: "Medication organization and explanation", token: "@medication-explainer-guidelines", path: "./prompts/Medication-explainer.md", seedGroup: OPEN_EVIDENCE_TASK_GUIDELINES_SEED_GROUP, task: { id: "medication_explainer_by_problem", label: "Medication organization and explanation", order: 7 } },
  { label: "Medication safety audit", token: "@medication-safety-guidelines", path: "./prompts/Medication-safety.md", seedGroup: OPEN_EVIDENCE_TASK_GUIDELINES_SEED_GROUP, task: { id: "medication_safety_audit", label: "Medication safety audit", order: 8 } },
  { label: "Checklist/workup refinement", token: "@checklist-refinement-guidelines", path: "./prompts/Checklist-refinement.md", seedGroup: OPEN_EVIDENCE_TASK_GUIDELINES_SEED_GROUP, task: { id: "checklist_workup_refinement", label: "Checklist/workup refinement", order: 9 } }
]);
...
export async function ensureTaskGuidelineSets(sets, { storage = localStorage } = {}) {
  ...
  return ensureObGynTaskGuidelineSets(withGeneralTasks, { storage });
}
