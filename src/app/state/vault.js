...
import { migrateLegacyDailySections, normalizeDiagnosticResultCategory, normalizeSourceCapture, normalizeSourceKindForScope } from "../../patient-context/source-captures.js?v=20260921-clinical-review-fix";
import { NOTE_TYPES, normalizeNoteDraft } from "../../note-drafts/index.js?v=20260921-clinical-review-fix";
