...
Sodium: 138`;
  ...
  assert.match(await wbcResult.locator("summary").innerText(), /No trend/, "results from another panel type must not be folded into the CBC trend");
  ...
  assert.match(await wbcResult.locator(".review-lab-trend-message").innerText(), /No trend available/);
  await wbcResult.locator("summary").click();
