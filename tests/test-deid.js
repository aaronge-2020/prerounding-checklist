...
const assertEpicRespResult = (pattern, message) => {
  assert.ok(pattern.test(epicRespImagingResult.text), message);
};
assertEpicRespResult(/BG Site: A-Line\b.*15:49/, "A-line blood gas site should remain clinical text with exact time");
assertEpicRespResult(/pH, Arterial: 7\.35\b.*10:42/, "blood gas result should preserve exact clock time");
assertEpicRespResult(/Oxygen Device: Ventilator\b.*09:54/, "vent setting row should preserve exact clock time");
assertEpicRespResult(/Mode: High Flow Nasal Cannula\b.*20:49/, "respiratory mode should not be treated as a name");
assertEpicRespResult(/WBC: 8\.8\b.*12:22/, "latest CBC before Day 0 should remain chronological");
assert.ok(epicRespImagingResult.text.includes("POC Glucose: 104 08:10 today"), "latest POC glucose should anchor Day 0");
assertEpicRespResult(/Card 1 Collection Date: 6 days ago\b.*10:28/, "Card 1 Collection Date should not override Day 0 and should not duplicate exact-time wording");
assertEpicRespResult(/Oral\/Maxillo Panorex Image By Clinic XR: Rpt\b.*17:39/, "imaging title containing Clinic should not be redacted as an organization");
assertEpicRespResult(/XR Metal Screening MR Clearance \(Abd\): Rpt\b.*15:42/, "XR metal screening title should not be redacted as a name");
assertEpicRespResult(/IR CV Tunneled Cath Insertion >=5 yrs: Rpt\b.*14:33/, "IR tunneled catheter title should be preserved");
assertEpicRespResult(/MR Shoulder W\+WO Con RIGHT: Rpt\b.*06:30/, "MR Shoulder W+WO title should be preserved");
assertEpicRespResult(/Request for: Plasma: Rpt\b.*10:55/, "blood product request rows should preserve exact clock time");
assertEpicRespResult(/Transfuse Platelets: Rpt  \|  Rpt\b.*20:43/, "transfusion rows should preserve exact clock time");
assertEpicRespResult(/Special Send Out Test: Rpt\b.*13:10/, "special send-out test should not be redacted as a facility");
assertEpicRespResult(/HCV Spec Site: Blood\b.*08:51/, "HCV spec site value Blood should remain clinical text");
assertEpicRespResult(/Iron: Not Performed\b.*06:19/, "Not Performed should remain a result value");
assertEpicRespResult(/Vitamin B-12: 322\b.*04:20/, "Vitamin B-12 should not be redacted as a name");
assertEpicRespResult(/BG Site: Peripheral Venous\b.*03:40/, "Peripheral Venous should remain a blood gas site value");
assertEpicRespResult(/Base Exc Art: -4\.1\b.*16:02/, "arterial base excess should preserve exact result time");
assertEpicRespResult(/Base Excess, Ven: -1\.8\b.*03:40/, "venous base excess should preserve exact result time");
assertEpicRespResult(/Hypochromasia: Moderate !.*21:16/, "morphology value should preserve exact result time");
assertEpicRespResult(/Microcytes: Moderate !.*21:16/, "microcyte morphology row should preserve exact result time");
assertEpicRespResult(/Retic CT %: 1\.23\b.*21:49/, "Retic CT should not create residual name warnings");
assertEpicRespResult(/Body Fluid Culture \(Aerobic\): Rpt !!.*13:38/, "body fluid culture should not create residual name warnings");
assertEpicRespResult(/QuantiFERON TB1 Ag Value: 0\.04\b.*09:40/, "QuantiFERON Ag Value should not create residual name warnings");
assertEpicRespResult(/Group A Streptococcus Screen w\/o Reflex: Rpt\b.*09:48/, "strep screen w/o reflex should not be redacted as a name");
assertEpicRespResult(/XR Ankle Min 3 Views Each Bilateral: Rpt \(E\).*14:56/, "bilateral ankle imaging title should not be redacted as a name");
assertEpicRespResult(/XR Foot 1 or 2 Views Each Bilateral: Rpt \(E\).*14:57/, "bilateral foot imaging title should not be redacted as a name");
assertEpicRespResult(/XR Hands 1 or 2 Views Each Bilateral: Rpt \(E\).*14:45/, "bilateral hand imaging title should not be redacted as a name");
assertEpicRespResult(/CAR Echo 2D w Agitated Saline Adult Comp: Rpt \(C\).*10:45/, "agitated saline echo title should not be redacted as a patient name");
assertEpicRespResult(/POCUS ANES Procedure Nerve or Fascial Plane Block: Rpt\b.*10:26/, "POCUS anesthesia fascial-plane block title should not create residual name warnings");
assertEpicRespResult(/Manual Diff\?: Yes\b.*11:19/, "manual differential result should keep exact time instead of a morning bucket");
assertEpicRespResult(/Cast Type: Hyaline casts\b.*12:15/, "cast type should keep exact time instead of an afternoon bucket");
assertEpicRespResult(/Ref Com Comments: H\/O Anti-K; No other antibody detected\..*07:59/, "blood-bank reference comments should keep exact time and not create name warnings");
assertEpicRespResult(/Clostridioides difficile DNA Assay: Rpt\b.*08:18/, "DNA Assay should not create residual name warnings");
...
assertEpicRespResult(/Antigen Typing: K Neg  \|  C Neg  \|  E Neg\b.*14:06/, "blood-bank antigen shorthand should not create residual name warnings");
assertEpicRespResult(/US Renal Transplant W\/Duplex: Rpt\b.*14:23/, "renal transplant ultrasound title should not create residual name warnings");
assertEpicRespResult(/Scanned External EKG\/ECG: Rpt\b.*00:00/, "scanned external EKG title should not create residual name warnings");
assertEpicRespResult(/Spec Gravity, Ur: 1\.030\b.*20:08/, "urine specific gravity should not create residual name warnings");
assertEpicRespResult(/Leukocyte Esterase, Ur: Trace !.*20:08/, "leukocyte esterase should not create residual name warnings");
assertEpicRespResult(/XR Elbow 2 Views LEFT: Rpt \(C\) \(E\).*20:25/, "elbow imaging title should not create residual name warnings");
assertEpicRespResult(/CT Cervical Spine W\/O Con: Rpt \(C\) \(E\).*19:29/, "CT cervical spine W/O contrast title should not create residual name warnings");
assertEpicRespResult(/CT Head\/Brain W\/O Con: Rpt\b.*19:06/, "CT head/brain W/O contrast title should not create residual name warnings");
assertEpicRespResult(/CT Upper Extremity WITH Con LEFT: Rpt\b.*19:06/, "CT upper extremity title should not create residual name warnings");
assertEpicRespResult(/US Soft Tissue Head\/Neck: Rpt \(E\).*14:23/, "US soft-tissue head/neck title should not create residual name warnings");
assertEpicRespResult(/VAS Venous Duplex LE Bilat Complete: Rpt\b.*11:58/, "LE bilateral venous duplex title should not create residual name warnings");
assertEpicRespResult(/VAS Venous Duplex UE Bilat Complete: Rpt\b.*12:38/, "UE bilateral venous duplex title should not create residual name warnings");
assertEpicRespResult(/POC SAT O2 ART: 98\b.*12:08/, "POC saturation label should not create residual name warnings");
assertEpicRespResult(/HCG Beta Subunit - QuaL: Negative\b.*06:19/, "HCG beta subunit label should remain clinical text");
assertEpicRespResult(/Quantiferon TB Gold: Indeterminate !.*15:54/, "Quantiferon result should keep exact time instead of an afternoon bucket");
assertEpicRespResult(/RPR Titer: Non Reactive\b.*13:30/, "RPR titer should keep exact time instead of an afternoon bucket");
assertEpicRespResult(/TREPONEMA PALLIDUM IGG AB: Minimal React\b.*03:14/, "Treponema serology should keep exact time instead of an early-morning bucket");
assertEpicRespResult(/Bacterial Vaginosis, RNA: Positive !.*12:00/, "Bacterial Vaginosis RNA should not be redacted as a name");
assertEpicRespResult(/Dolutegravir Resistance: NOT PREDICTED\b.*15:02/, "HIV resistance rows should keep exact time instead of an afternoon bucket");
assertEpicRespResult(/Casts: None seen\b.*15:04/, "urine casts result should keep exact time instead of an afternoon bucket");
assertEpicRespResult(/Microscopic Examination of Urine: See Comment\b.*00:00/, "urine microscopy label should not be redacted as a name");
assertEpicRespResult(/Antibody Identification: Cold Autoantibody\b.*06:19/, "cold autoantibody result value should not be redacted as a name");
assertEpicRespResult(/DIRECT COOMBS-C3D: Negative\b.*14:26/, "COOMBS-C3D should remain a clinical label, not an ID placeholder");
assertEpicRespResult(/Tissue Examination: Rpt \(P\).*10:43/, "tissue examination label should not be redacted as a name");
assertEpicRespResult(/XR Chest 1 View Post Intervention: Rpt \(C\) \(E\).*12:15/, "post-intervention imaging title should not be redacted as a name");
assertEpicRespResult(/POC SARS COV-2 \(COVID-19\) Ag: Negative\b.*04:02/, "COVID-19 should remain a clinical label token, not an ID placeholder");
assertEpicRespResult(/SARS-CoV-2 \(COVID-19\) RNA: Not Detected\b.*06:10/, "SARS-CoV-2 COVID-19 RNA label should be preserved");
assertEpicRespResult(/Test Cup: Plain Cup\b.*15:00/, "TEG cup descriptor should keep exact result time");
assertEpicRespResult(/Appearance, Ur: Slightly Cloudy\b.*18:57/, "urine appearance descriptor should keep exact result time");
assertEpicRespResult(/Ketones, Ur: Trace !.*18:57/, "urine trace values should not be treated as narrative time");
assertEpicRespResult(/Mucus, Ur: Small\b.*18:57/, "urine small values should not be treated as names or narrative time");
assertEpicRespResult(/^Appearance: Clear\b.*01:51/m, "generic appearance row should preserve exact result time");
assertEpicRespResult(/R Axis: -2\b.*18:12/, "EKG axis result should keep exact result time");
assertEpicRespResult(/Banding Type: FISH\b.*02:31/, "cytogenetics banding row should keep exact result time");
assertEpicRespResult(/Source: Blood\n\s*5 days ago at 02:31/, "standalone timestamp after specimen source should keep exact result time");
assertEpicRespResult(/TEG Platelet Aggregation \(MA\): 68\.3\b.*15:00/, "TEG platelet aggregation should not be redacted as a name");
assertEpicRespResult(/TEG Fibrinogen Activity \(Angle\): 65\.2\b.*15:00/, "TEG fibrinogen activity should not create residual name warnings");
assertEpicRespResult(/TEG Clotting Time \(R\): 9\.5\b.*15:00/, "TEG clotting time should not create residual name warnings");
assertEpicRespResult(/Beta HCG Tumor Marker \(Male\): 2080 \(H\).*04:33/, "tumor-marker lab label should not be redacted as a patient name");
assertEpicRespResult(/XR Hip Bilateral & Pelvis 2 Views: Rpt\b.*17:57/, "hip/pelvis imaging title should not be redacted as a name");
assertEpicRespResult(/Prelim Result: Normal FISH\b.*02:31/, "Normal FISH result should remain clinical text");
assertEpicRespResult(/XR FEMUR 2 VIEWS: Rpt\b.*22:25/, "all-caps femur imaging title should not create name warnings");
assertEpicRespResult(/XR FOOT MIN 3 VIEWS: Rpt\b.*22:25/, "all-caps foot imaging title should not create name warnings");
