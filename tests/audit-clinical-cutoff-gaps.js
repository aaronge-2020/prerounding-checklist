...
const prohibitedGenericNodePatterns = [
  ...
  /route by findings/i,
  /assessment and key results/i,
  /key labs\/results|key results/i,
  /threshold labs\/results|threshold results/i,
  /classify risk and disposition/i,
  /treatment safety resolved/i,
  /clinician review modifier/i,
  /local protocol dependency/i,
  /objective findings favor/i,
  /active branch/i,
  /Interpret with local lab ranges/i,
  /Reference anchors/i,
  /Patient-specific contraindication, special population/i,
  /Competing diagnosis or exclusion changes the active pathway/i,
  /repeat critical [^.]+ objective data/i,
  /(?:the|an) abnormal cutoff|using the abnormal cutoff|according to the abnormal cutoff/i,
  /danger features?/i,
  /crisis labs/i,
  /obtain targeted tests/i,
  /targeted tests and cultures/i,
  /concurrent data bundle obtained/i,
  /criteria match/i,
  /does patient context support this workup/i,
  ...
  /Missing data needed/i,
  /Missing data:/i,
  /Missing context:/i,
  /Cannot distinguish/i,
  /Cannot classify/i,
  /cannot [^.;]+ until [^.;]+ known/i,
  /branch-specific criteria in this node apply/i,
  /criterion-defining results/i,
  /documented disease branch/i,
  /source-directed/i,
  /route by/i,
