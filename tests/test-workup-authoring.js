...
assert.equal(packageJson.scripts["test:workup-authoring"], "node tests/test-workup-authoring.js");
assert.equal(existsSync(new URL("../supabase", import.meta.url)), false, "Hosted authoring migrations should be removed.");

console.log("Workup authoring snapshot/export and section-safety tests passed.");
