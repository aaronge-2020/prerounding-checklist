...
export function attendingDischargePlanPrompt(context) {
  return buildPatientPrompt(
    context,
    `${taskBoundary({
  primary: "Using OpenEvidence, produce an attending-level discharge plan for the de-identified case below, assuming discharge criteria are met: medication reconciliation and instructions, follow-up, activity/diet/work restrictions, pending-result follow-up, and return precautions.",
  notFor: [
